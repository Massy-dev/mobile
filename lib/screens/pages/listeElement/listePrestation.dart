...
class ListePrestation extends StatefulWidget {
  final String detailId;
  ListePrestation({required this.detailId});

  @override
  State<ListePrestation> createState() => _ListePrestationState();
}

class _ListePrestationState extends State<ListePrestation> {
// Prestation élémént
